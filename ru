...
xkb_symbols "winkeys" {
    ...
    key <AE03> { [           3,  section, threesuperior, numerosign  ] };
    key <AE04> { [           4,  dollar  ] };
    key <AE05> { [           5,  percent  ] };
    ...
    key <AE11> { [           Cyrillic_softsign, question, backslash, Cyrillic_SOFTSIGN ] };
    key <AE12> { [           Cyrillic_yu, Cyrillic_YU, dead_acute, dead_grave ] };

    key <AD12> { [ plus, asterisk, Cyrillic_hardsign, Cyrillic_HARDSIGN  ] };

    key <BKSL>	{ [numbersign, apostrophe, rightsinglequotemark,   dead_breve ]	};

    key <LSGT> { [ less, greater, bar  ] };

    key <AB07> { [      Cyrillic_be, Cyrillic_BE, mu  ] };
    key <AB08> { [      comma, semicolon  ] };
    key <AB09> { [      period, colon ] };
    key <AB10> { [      minus, underscore, endash, emdash  ] };

    key <AD01>	{ [  Cyrillic_shorti,   Cyrillic_SHORTI,     at,     at ]	};
    key <AD03>	{ [  Cyrillic_u,        Cyrillic_U,      EuroSign,     EuroSign ]	};
...
xkb_symbols "common" {
    ...
    key <TLDE> { [       Cyrillic_io,       Cyrillic_IO, dead_circumflex, degree  ] };
